...
function  newItem(){
    ...
    let oStr = `<tr><td>${itemName}</td><td>${dateFound}</td><td>${timeLog}</td><td>${category}</td><td>${desc}</td><td>${locationFound}</td><td>${locationDetails}</td><td>${personFound}</td>personFound</tr>`;
