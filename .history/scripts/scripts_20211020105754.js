...
function  newItem(){
    ...
    let dateFoundRow = row.insertCell(2);
    let timeLogRow = row.insertCell(3);
    let categoryRow = row.insertCell(4);
    let descRow = row.insertCell(5);
    let locationFoundRow = row.insertCell(6);
    let locationDetailsRow = row.insertCell();
